                    ...
                    <Col xs={12} sm={12} md={6} lg={6} xl={6} xxl={6} >
                        <Form.Group className="mb-3 imgBox" controlId="formBasicProfileImg">
                            ...
                            <Form.Select
                                ...
                                onChange={handleChange}>
                                <option>Abrir el desplegable</option>
                                <option value="../../Img/avatar1.jpg" className='avatar avatar1'>Imagen 1</option>
                                <option value="../../Img/avatar2.jpg" className='avatar avatar2'>Imagen 2</option>
                                <option value="../../Img/avatar3.jpg" className='avatar avatar3'>Imagen 3</option>
                                <option value="../../Img/avatar4.jpg" className='avatar avatar4'>Imagen 4</option>
                                <option value="../../Img/avatar5.jpg" className='avatar avatar5'>Imagen 5</option>
                                <option value="../../Img/avatar6.jpg" className='avatar avatar6'>Imagen 6</option>
                                <option value="../../Img/avatar7.jpg" className='avatar avatar7'>Imagen 7</option>
                                <option value="../../Img/avatar8.jpg" className='avatar avatar8'>Imagen 8</option>
                                <option value="../../Img/avatar9.jpg" className='avatar avatar9'>Imagen 9</option>
                                <option value="../../Img/avatar10.jpg" className='avatar avatar10'>Imagen 10</option>
